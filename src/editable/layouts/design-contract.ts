...
export const editableRootStyle = {
  ...
  '--slot4-page-bg': '#E1DCC9',
  '--slot4-page-text': '#000000',
  '--slot4-panel-bg': '#D5CEB7',
  '--slot4-surface-bg': '#E1DCC9',
  '--slot4-muted-text': '#412D15',
  '--slot4-soft-muted-text': '#412D15',
  '--slot4-accent': '#412D15',
  '--slot4-accent-fill': '#412D15',
  '--slot4-accent-soft': '#C8BEA5',
  '--slot4-on-accent': '#E1DCC9',
  '--slot4-dark-bg': '#000000',
  '--slot4-dark-text': '#E1DCC9',
  '--slot4-media-bg': '#1F150C',
  '--slot4-cream': '#E1DCC9',
  '--slot4-warm': '#D5CEB7',
  '--slot4-lavender': '#E1DCC9',
  '--slot4-gray': '#D5CEB7',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#E1DCC9',
  '--editable-page-text': '#000000',
  '--editable-container': '1160px',
  '--editable-border': '#412D15',
  '--editable-nav-bg': '#E1DCC9',
  '--editable-nav-text': '#000000',
  '--editable-nav-active': '#412D15',
  '--editable-nav-active-text': '#E1DCC9',
  '--editable-cta-bg': '#412D15',
  '--editable-cta-text': '#E1DCC9',
  '--editable-search-bg': '#E1DCC9',
  '--editable-footer-bg': '#000000',
  '--editable-footer-text': '#E1DCC9',
} as CSSProperties
